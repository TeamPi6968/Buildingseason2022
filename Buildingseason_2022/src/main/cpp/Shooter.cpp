...
Shooter::Shooter(frc::PS4Controller *controller) //create shoota objekt
{
...
void Shooter::AutoInit(){  //autonomous mode initialization
    ...
    BottomL.Set(ControlMode::PercentOutput, 0.63); //Bottom R and TopSpinner motor follow bottom L motor so all three are set to 63% of max motorspeed
